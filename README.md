...
Model version
RMSE
Version 1: Baseline, trained on 3 mini releases
0.7512
Version 2: Baseline with late fusion for demographic data , trained on one mini release
0.7275
Version 3: Version 2 model trained on all 11 mini releases of data 
0.7301
Version 4: Baseline line with late fusion for demographic data and self attention Mechanism, trained on one full release
0.7401
